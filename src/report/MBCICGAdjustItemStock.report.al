            ...
            dataitem(Item; Item)
            {
                ...
                begin
                    ...
                    if Item.Inventory <> 0 then begin
                        AdjustStock(Item."No.", DocumentNoLbl, -Item.Inventory, Location.Code, '', '', '', copystr(UserId, 1, 50), 0D);
                        AdjustComponentStock(Item."No.", Location.Code, Item.Inventory);
                    end;
    ...
    begin
        ...
        repeat
            ...
            if ItemTrackingCode."Lot Specific Tracking" then
                LotNo := 'ADJUSTS';//MBCICGConnectorConfig."Lot. No. Adjust";
